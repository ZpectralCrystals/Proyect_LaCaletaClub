...
import { ShoppingCart, Minus, Plus, Trash2 } from "lucide-react"; // o tus íconos preferidos
  ...
  const products: Product[] = [
    {
      ...
      price: 25.0,
      quantity: 2,
      image: "public/products/productA.jpg",
    },
    {
      id: "2",
      name: "Producto B",
      ...
      price: 15.5,
      quantity: 1,
      image: "public/products/productB.jpg",
    },
  ];
                  ...
                  <div key={item.id} className="flex gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center justify-between mt-2">
                        ...
                        {/* Controles cantidad (sin funcionalidad) */}
                    ...
                    <Button variant="ghost" size="icon" className="h-8 w-8 text-gray-400 hover:text-red-500" disabled>
        ...
        {products.length > 0 && (
          <SheetFooter className="mt-auto pt-4">
            <div className="w-full space-y-4">
              ...
              <Button className="w-full bg-gray-900 hover:bg-gray-800">Proceder al pago</Button>
            </div>
          </SheetFooter>
        )}
      </SheetContent>

...
var Recomendaciones = function () {
    var _a = (0, react_1.useState)([]), resenas = _a[0], setResenas = _a[1];
    ...
    return (<main className="min-h-screen bg-white py-16 px-6">
      <section className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {resenas.map(function (cliente) { return (<div key={cliente.id} className="bg-blue-50 p-6 rounded-xl shadow-md flex flex-col items-center text-center">
              <img src={cliente.imagen} alt={cliente.nombre} className="w-20 h-20 rounded-full object-cover mb-4 border-4 border-sky-200"/>
...
exports.default = Recomendaciones;

          ...
          {products.map((product) => (
            <tr key={product.id}>
              ...
              <td className="border px-4 py-2 text-center">
                <Button variant="ghost" onClick={() => onToggleActive(product.id, product.isActive)}>
                  <FontAwesomeIcon icon={product.isActive ? faToggleOn : faToggleOff} className={`text-xl ${product.isActive ? 'text-green-500' : 'text-gray-400'}`} />
                </Button>
              </td>
              <td className="border px-4 py-2 text-center">
                <Button variant="ghost" onClick={() => onToggleFavorite(product.id, product.isFavorite)}>
                  <FontAwesomeIcon icon={product.isFavorite ? faToggleOn : faToggleOff} className={`text-xl ${product.isFavorite ? 'text-green-500' : 'text-gray-400'}`} />
                </Button>
              </td>

    ...
    return (<main className="bg-white min-h-screen">
      ...
      <section className="relative bg-[url('/slider-bg2.jpg')] bg-cover bg-center min-h-[80vh] flex items-center justify-center text-white">
        ...
        <div className="relative z-10 text-center px-6">
          ...
          <react_router_dom_1.Link to="/menu">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="overflow-x-auto no-scrollbar">
            <div className="flex gap-6 w-max">
              {productosDestacados.map(function (p) { return (<div key={p.id} className="bg-white border border-sky-200 shadow-md hover:shadow-lg rounded-xl overflow-hidden relative w-[260px] flex-shrink-0 transition-all">
                  <img src={p.imagen} alt={p.nombre} className="w-full h-52 object-cover"/>
      ...
      <section className="bg-sky-600 text-white text-center py-16 px-6">
        ...
        <react_router_dom_1.Link to="/registro">
